...
class File extends Model
{
    ...
    public function scopeFilterDocumentVersions(Builder $query, int $fileableId): Builder
    {
        return $query->where(function (Builder $query) use ($fileableId): Builder {
            return $query->orWhere('fileable_id', $fileableId)->where('fileable_type','App\Models\Users\UserDoc');
